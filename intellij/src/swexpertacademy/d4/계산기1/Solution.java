package src.swexpertacademy.d4.계산기1;
...
class Solution {
    ...
    public static void main(String args[]) throws Exception {
        System.setIn(new FileInputStream("src/swexpertacademy/d4/계산기1/input.txt"));
    ...
    static void toPostfixNotation() {
        ...
        for (String s : infixNotation) {
            if (s.matches("[0-9]")) {
                ...
                if (!stack.isEmpty()) {
                    if (operatorPriority.get(operator) >= operatorPriority.get(stack.peek())) {
